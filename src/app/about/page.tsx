...
export default function AboutPage() {
  ...
  // Sample FAQ data for ElectroRcade
  const faqItems = [
    { 
          ...
          <div className="space-y-12">
            ...
            >
              <div className="bg-black/50 border border-neon-blue rounded-lg p-8">
                ...
                <div className="text-gray-300 space-y-4 leading-relaxed">
                  <p>
                    ElectroRcade was created with a simple yet powerful vision: to combine the nostalgic joy of arcade gaming with the innovative potential of blockchain technology. Our mission is to build a thriving play-to-earn ecosystem where skill is rewarded and fun is paramount.
                  </p>
                  <p>
              ...
              <div className="bg-black/50 border border-neon-pink rounded-lg p-8">
                ...
                <div className="flex flex-col md:flex-row items-center gap-8 mb-6">
                  <div className="flex-1 text-gray-300 space-y-4 leading-relaxed">
                    <p>
                      ElectroRcade is built on Electroneum, a secure and efficient blockchain designed for usability and speed. All transactions, game results, and prize distributions are recorded on-chain for complete transparency.
                    </p>
                    <p>
            ...
            >
              <div className="bg-black/50 border border-neon-blue rounded-lg p-8">
                ...
                <div className="text-gray-300 space-y-4 leading-relaxed">
                  <p>
                    ElectroRcade features a growing collection of skill-based mini-games, each with its own unique gameplay and challenge. Our games are designed to be easy to learn but difficult to master, rewarding practice and skill development.
                  </p>
                </div>
          ...
          >
            ...
            <div className="mt-12 p-8 bg-black/30 border border-gray-800 rounded-lg text-center">
              ...
              <div className="text-center">
                <a 
                  href="mailto:contact@electrorcade.io" 
        ...
        {activeTab === 'faq' && (
          ...
          >
            ...
            <div className="mt-12 text-center">
              ...
              <a 
                href="mailto:support@electrorcade.io" 
